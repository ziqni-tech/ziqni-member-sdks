 ...
 * @version 0.0.1
 */
var AwardResponse = /*#__PURE__*/function () {
  /**
  ...
  _createClass(AwardResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_Award["default"]]);
        }
