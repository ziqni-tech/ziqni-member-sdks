 ...
 * @version 0.0.1
 */
var RewardRequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RewardRequest</code>.
   * @alias module:model/RewardRequest
   * @param entityId {String} 
   */
  function RewardRequest(entityId) {
    _classCallCheck(this, RewardRequest);
  ...
  _createClass(RewardRequest, null, [{
    key: "initialize",
    value: function initialize(obj, entityId) {
