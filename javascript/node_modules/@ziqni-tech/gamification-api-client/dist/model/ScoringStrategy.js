...
var ScoringStrategy = /*#__PURE__*/function () {
  ...
  _createClass(ScoringStrategy, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('limitUpdatesTo')) {
          obj['limitUpdatesTo'] = _ApiClient["default"].convertToType(data['limitUpdatesTo'], 'Number');
        }

        if (data.hasOwnProperty('sumBestXOf')) {
          obj['sumBestXOf'] = _ApiClient["default"].convertToType(data['sumBestXOf'], 'Number');
        }

        if (data.hasOwnProperty('lastUpdateTimeStamp')) {
          obj['lastUpdateTimeStamp'] = _ApiClient["default"].convertToType(data['lastUpdateTimeStamp'], 'Number');
        }

        if (data.hasOwnProperty('recordTimeWhenSumReaches')) {
          obj['recordTimeWhenSumReaches'] = _ApiClient["default"].convertToType(data['recordTimeWhenSumReaches'], 'Number');
        }
      }
