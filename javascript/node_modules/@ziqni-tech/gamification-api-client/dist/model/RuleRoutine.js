...
var _RuleArgument = _interopRequireDefault(require("./RuleArgument"));
 ...
 * @version 0.0.1
 */
var RuleRoutine = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RuleRoutine</code>.
   * @alias module:model/RuleRoutine
   */
  function RuleRoutine() {
    _classCallCheck(this, RuleRoutine);
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('routine')) {
          obj['routine'] = _ApiClient["default"].convertToType(data['routine'], 'String');
        }

        if (data.hasOwnProperty('arguments')) {
          obj['arguments'] = _ApiClient["default"].convertToType(data['arguments'], [_RuleArgument["default"]]);
        }
