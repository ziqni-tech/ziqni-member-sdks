...
var _AwardFilter = _interopRequireDefault(require("./AwardFilter"));
 ...
 * @version 0.0.1
 */
var AwardRequest = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AwardRequest</code>.
   * @alias module:model/AwardRequest
   * @param memberRefId {String} 
   */
  function AwardRequest(memberRefId) {
    _classCallCheck(this, AwardRequest);
  ...
  _createClass(AwardRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('awardFilter')) {
          obj['awardFilter'] = _AwardFilter["default"].constructFromObject(data['awardFilter']);
        }
      }
