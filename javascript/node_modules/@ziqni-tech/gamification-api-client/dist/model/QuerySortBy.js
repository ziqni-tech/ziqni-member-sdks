 ...
 * @version 0.0.1
 */
var QuerySortBy = /*#__PURE__*/function () {
  /**
   ...
   */
  function QuerySortBy(queryField, order) {
    _classCallCheck(this, QuerySortBy);
  ...
  _createClass(QuerySortBy, null, [{
    key: "initialize",
    value: function initialize(obj, queryField, order) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('order')) {
          obj['order'] = _SortOrder["default"].constructFromObject(data['order']);
        }
      }
