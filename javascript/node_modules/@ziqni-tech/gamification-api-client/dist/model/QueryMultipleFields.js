 ...
 * @version 0.0.1
 */
var QueryMultipleFields = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>QueryMultipleFields</code>.
   * @alias module:model/QueryMultipleFields
   */
  function QueryMultipleFields() {
    _classCallCheck(this, QueryMultipleFields);
  ...
  _createClass(QueryMultipleFields, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('queryFields')) {
          obj['queryFields'] = _ApiClient["default"].convertToType(data['queryFields'], ['String']);
        }

        if (data.hasOwnProperty('queryValue')) {
          obj['queryValue'] = _ApiClient["default"].convertToType(data['queryValue'], 'String');
        }
      }
...
var _default = QueryMultipleFields;
