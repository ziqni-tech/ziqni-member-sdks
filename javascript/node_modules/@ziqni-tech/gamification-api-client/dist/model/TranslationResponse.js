...
var _ResponseMeta = _interopRequireDefault(require("./ResponseMeta"));
...
var TranslationResponse = /*#__PURE__*/function () {
  ...
  _createClass(TranslationResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('meta')) {
          obj['meta'] = _ResponseMeta["default"].constructFromObject(data['meta']);
        }

        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_Translation["default"]]);
        }
...
var _default = TranslationResponse;
