...
var _RankingStrategy = _interopRequireDefault(require("./RankingStrategy"));

var _ScoringStrategy = _interopRequireDefault(require("./ScoringStrategy"));

var _StrategyType = _interopRequireDefault(require("./StrategyType"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('strategyType')) {
          obj['strategyType'] = _StrategyType["default"].constructFromObject(data['strategyType']);
        }

        if (data.hasOwnProperty('rankingStrategy')) {
          obj['rankingStrategy'] = _RankingStrategy["default"].constructFromObject(data['rankingStrategy']);
        }

        if (data.hasOwnProperty('scoringStrategy')) {
          obj['scoringStrategy'] = _ScoringStrategy["default"].constructFromObject(data['scoringStrategy']);
        }
      }
