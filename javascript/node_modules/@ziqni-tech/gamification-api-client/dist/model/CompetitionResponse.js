...
var _Competition = _interopRequireDefault(require("./Competition"));
 ...
 * @version 0.0.1
 */
var CompetitionResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CompetitionResponse</code>.
   * @alias module:model/CompetitionResponse
   */
  function CompetitionResponse() {
    _classCallCheck(this, CompetitionResponse);
  ...
  _createClass(CompetitionResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_Competition["default"]]);
        }
...
var _default = CompetitionResponse;
