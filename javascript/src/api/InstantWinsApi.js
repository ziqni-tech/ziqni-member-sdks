...
export default class InstantWinsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the donateInstantWinPlays operation.
     * @callback module:api/InstantWinsApi~donateInstantWinPlaysCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InstantWinsAvailablePlayResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * @param {module:model/InstantWinDonateRequest} instantWinDonateRequest 
     * @param {module:api/InstantWinsApi~donateInstantWinPlaysCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InstantWinsAvailablePlayResponse}
     */
    donateInstantWinPlays(instantWinDonateRequest, callback) {
      let postBody = instantWinDonateRequest;
      // verify the required parameter 'instantWinDonateRequest' is set
    ...
    /**
     * Callback function to receive the result of the getInstantWinAvailablePlays operation.
     * @callback module:api/InstantWinsApi~getInstantWinAvailablePlaysCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InstantWinsAvailablePlayResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * @param {module:model/InstantWinAvailablePlaysRequest} instantWinAvailablePlaysRequest 
     * @param {module:api/InstantWinsApi~getInstantWinAvailablePlaysCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InstantWinsAvailablePlayResponse}
     */
    getInstantWinAvailablePlays(instantWinAvailablePlaysRequest, callback) {
      let postBody = instantWinAvailablePlaysRequest;
      // verify the required parameter 'instantWinAvailablePlaysRequest' is set
      ...
      let returnType = InstantWinsAvailablePlayResponse;
      return this.apiClient.callApi(
        '/instant-wins-available-plays', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
