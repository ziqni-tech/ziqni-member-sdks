...
export default class AwardsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the declineAwards operation.
     * @callback module:api/AwardsApi~declineAwardsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AwardResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Claim awards.
     * This operation enables a member to claim awards.
     * @param {module:model/DeclineAwardRequest} declineAwardRequest 
     * @param {module:api/AwardsApi~declineAwardsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AwardResponse}
     */
    declineAwards(declineAwardRequest, callback) {
      let postBody = declineAwardRequest;
      // verify the required parameter 'declineAwardRequest' is set
