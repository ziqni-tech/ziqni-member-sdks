...
class Strategy {
    ...
    static validateJSON(data) {
        // validate the optional field `rankingStrategy`
        if (data['rankingStrategy']) { // data not null
          RankingStrategy.validateJSON(data['rankingStrategy']);
        }
        // validate the optional field `scoringStrategy`
        if (data['scoringStrategy']) { // data not null
          ScoringStrategy.validateJSON(data['scoringStrategy']);
        }
