...
class LeaderboardSubscriptionRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>LeaderboardSubscriptionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LeaderboardSubscriptionRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LeaderboardSubscriptionRequest.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // validate the optional field `leaderboardFilter`
        if (data['leaderboardFilter']) { // data not null
          LeaderboardFilter.validateJSON(data['leaderboardFilter']);
        }
...
LeaderboardSubscriptionRequest.RequiredProperties = ["entityId", "action"];
