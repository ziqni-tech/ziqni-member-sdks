...
class CallbacksResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>CallbacksResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CallbacksResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CallbacksResponse.RequiredProperties) {
        ...
        if (data['callback']) { // data not null
            ...
            if (!Array.isArray(data['callback'])) {
                throw new Error("Expected the field `callback` to be an array in the JSON data but got " + data['callback']);
            }
            // validate the optional field `callback` (array)
            for (const item of data['callback']) {
                CallbackEntry.validateJSON(item);
            };
        }
...
CallbacksResponse.RequiredProperties = ["callback"];
