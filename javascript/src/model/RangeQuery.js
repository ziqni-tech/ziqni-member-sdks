...
class RangeQuery {
    ...
    /**
     * Validates the JSON data with respect to <code>RangeQuery</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RangeQuery</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['gt'] && !(typeof data['gt'] === 'string' || data['gt'] instanceof String)) {
            throw new Error("Expected the field `gt` to be a primitive type in the JSON string but got " + data['gt']);
        }
        // ensure the json data is a string
        if (data['lt'] && !(typeof data['lt'] === 'string' || data['lt'] instanceof String)) {
            throw new Error("Expected the field `lt` to be a primitive type in the JSON string but got " + data['lt']);
        }
