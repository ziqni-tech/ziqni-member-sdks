...
class DependantOn {
    ...
    /**
     * Validates the JSON data with respect to <code>DependantOn</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DependantOn</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is an array
        if (!Array.isArray(data['mustNot'])) {
            throw new Error("Expected the field `mustNot` to be an array in the JSON data but got " + data['mustNot']);
        }
        // ensure the json data is an array
