...
class RewardTypeReduced {
    ...
    /**
     * Validates the JSON data with respect to <code>RewardTypeReduced</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RewardTypeReduced</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['uomIsoCode'] && !(typeof data['uomIsoCode'] === 'string' || data['uomIsoCode'] instanceof String)) {
            throw new Error("Expected the field `uomIsoCode` to be a primitive type in the JSON string but got " + data['uomIsoCode']);
        }
        // ensure the json data is a string
        if (data['uomSymbol'] && !(typeof data['uomSymbol'] === 'string' || data['uomSymbol'] instanceof String)) {
            throw new Error("Expected the field `uomSymbol` to be a primitive type in the JSON string but got " + data['uomSymbol']);
        }
        // ensure the json data is a string
        if (data['uomType'] && !(typeof data['uomType'] === 'string' || data['uomType'] instanceof String)) {
            throw new Error("Expected the field `uomType` to be a primitive type in the JSON string but got " + data['uomType']);
        }
