...
class LeaderboardEntry {
    ...
    static validateJSON(data) {
        ...
        for (const property of LeaderboardEntry.RequiredProperties) {
        ...
        if (!Array.isArray(data['bestScores'])) {
            throw new Error("Expected the field `bestScores` to be an array in the JSON data but got " + data['bestScores']);
        }
        if (data['members']) { // data not null
            ...
            for (const item of data['members']) {
                LeaderboardMember.validateJSON(item);
            };
        }
...
LeaderboardEntry.RequiredProperties = ["rank", "members"];
