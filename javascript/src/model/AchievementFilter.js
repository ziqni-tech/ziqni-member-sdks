...
class AchievementFilter {
    ...
    /**
     * Validates the JSON data with respect to <code>AchievementFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AchievementFilter</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of AchievementFilter.RequiredProperties) {
        ...
        if (data['startDate']) { // data not null
          DateRange.validateJSON(data['startDate']);
        }
        // validate the optional field `endDate`
        if (data['endDate']) { // data not null
          DateRange.validateJSON(data['endDate']);
        }
        // ensure the json data is an array
        ...
        if (data['statusCode']) { // data not null
          NumberRange.validateJSON(data['statusCode']);
        }
        ...
        if (!Array.isArray(data['productTags'])) {
            throw new Error("Expected the field `productTags` to be an array in the JSON data but got " + data['productTags']);
        }
        // ensure the json data is an array
        ...
        if (!Array.isArray(data['scheduleTypes'])) {
            throw new Error("Expected the field `scheduleTypes` to be an array in the JSON data but got " + data['scheduleTypes']);
        }
...
AchievementFilter.RequiredProperties = ["includeOptInState"];
