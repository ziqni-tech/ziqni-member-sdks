...
class InstantWinsAvailablePlayResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>InstantWinsAvailablePlayResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InstantWinsAvailablePlayResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                InstantWinsAvailablePlayResults.validateJSON(item);
            };
        }
