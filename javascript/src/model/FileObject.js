...
class FileObject {
     ...
     */
    constructor(id, repositoryId, name, mimeType, path, parentFolderPath) { 
        ModelDefault.initialize(this, id);OptionalModelFields.initialize(this);FileObjectAllOf.initialize(this, repositoryId, name, mimeType, path, parentFolderPath);
        FileObject.initialize(this, id, repositoryId, name, mimeType, path, parentFolderPath);
    }
     ...
     */
    static initialize(obj, id, repositoryId, name, mimeType, path, parentFolderPath) { 
        obj['id'] = id;
