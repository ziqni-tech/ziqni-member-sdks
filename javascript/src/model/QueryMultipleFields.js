...
class QueryMultipleFields {
    ...
    /**
     * Validates the JSON data with respect to <code>QueryMultipleFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QueryMultipleFields</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['queryFields'])) {
            throw new Error("Expected the field `queryFields` to be an array in the JSON data but got " + data['queryFields']);
        }
        // ensure the json data is a string
        if (data['queryValue'] && !(typeof data['queryValue'] === 'string' || data['queryValue'] instanceof String)) {
            throw new Error("Expected the field `queryValue` to be a primitive type in the JSON string but got " + data['queryValue']);
        }
