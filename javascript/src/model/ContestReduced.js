...
class ContestReduced {
    ...
    /**
     * Validates the JSON data with respect to <code>ContestReduced</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContestReduced</code>.
     */
    static validateJSON(data) {
        ...
        if (data['rewards']) { // data not null
            ...
            for (const item of data['rewards']) {
                RewardReduced.validateJSON(item);
            };
        }
