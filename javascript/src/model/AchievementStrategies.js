...
class AchievementStrategies {
    ...
    /**
     * Validates the JSON data with respect to <code>AchievementStrategies</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AchievementStrategies</code>.
     */
    static validateJSON(data) {
        // validate the optional field `pointsStrategy`
        if (data['pointsStrategy']) { // data not null
          PointsStrategy.validateJSON(data['pointsStrategy']);
        }
