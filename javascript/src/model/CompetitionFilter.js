...
class CompetitionFilter {
    ...
    /**
     * Validates the JSON data with respect to <code>CompetitionFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompetitionFilter</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `endDateRange`
        if (data['endDateRange']) { // data not null
          DateRange.validateJSON(data['endDateRange']);
        }
        // validate the optional field `startDateRange`
        if (data['startDateRange']) { // data not null
          DateRange.validateJSON(data['startDateRange']);
        }
