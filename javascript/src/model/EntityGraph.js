...
class EntityGraph {
    ...
    /**
     * Validates the JSON data with respect to <code>EntityGraph</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntityGraph</code>.
     */
    static validateJSON(data) {
        if (data['edges']) { // data not null
            ...
            for (const item of data['edges']) {
                EntityGraphEdge.validateJSON(item);
            };
        }
