...
class RuleRoutine {
    ...
    /**
     * Validates the JSON data with respect to <code>RuleRoutine</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleRoutine</code>.
     */
    static validateJSON(data) {
        ...
        if (data['arguments']) { // data not null
            ...
            for (const item of data['arguments']) {
                RuleArgument.validateJSON(item);
            };
        }
