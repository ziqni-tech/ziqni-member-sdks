...
class CompetitionRequest {
    ...
    /**
     * Validates the JSON data with respect to <code>CompetitionRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CompetitionRequest</code>.
     */
    static validateJSON(data) {
        ...
        // validate the optional field `competitionFilter`
        if (data['competitionFilter']) { // data not null
          CompetitionFilter.validateJSON(data['competitionFilter']);
        }
