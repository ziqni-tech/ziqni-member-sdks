...
class EntityStateChanged {
    ...
    /**
     * Validates the JSON data with respect to <code>EntityStateChanged</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EntityStateChanged</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['changedBy'] && !(typeof data['changedBy'] === 'string' || data['changedBy'] instanceof String)) {
            throw new Error("Expected the field `changedBy` to be a primitive type in the JSON string but got " + data['changedBy']);
        }
        // ensure the json data is a string
        ...
        // ensure the json data is a string
        if (data['entityRefId'] && !(typeof data['entityRefId'] === 'string' || data['entityRefId'] instanceof String)) {
            throw new Error("Expected the field `entityRefId` to be a primitive type in the JSON string but got " + data['entityRefId']);
        }
        // ensure the json data is a string
        if (data['entityParentId'] && !(typeof data['entityParentId'] === 'string' || data['entityParentId'] instanceof String)) {
            throw new Error("Expected the field `entityParentId` to be a primitive type in the JSON string but got " + data['entityParentId']);
        }
