...
import AwardReduced from './model/AwardReduced';
import AwardReducedAllOf from './model/AwardReducedAllOf';
import AwardRequest from './model/AwardRequest';
import AwardResponse from './model/AwardResponse';
import AwardStateActions from './model/AwardStateActions';
...
import DeclineAwardRequest from './model/DeclineAwardRequest';
...
import InstantWinAvailablePlaysRequest from './model/InstantWinAvailablePlaysRequest';
import InstantWinDonateRequest from './model/InstantWinDonateRequest';
...
import InstantWinPlayResults from './model/InstantWinPlayResults';
...
import InstantWinsAvailablePlayResponse from './model/InstantWinsAvailablePlayResponse';
import InstantWinsAvailablePlayResults from './model/InstantWinsAvailablePlayResults';
...
import MemberTokenInfo from './model/MemberTokenInfo';
...
import UpdateMessageStateRequestAllOf from './model/UpdateMessageStateRequestAllOf';
...
import MemberTokenApiWs from './api/MemberTokenApiWs';
...
export {
    ...
    /**
     * The AwardReduced model constructor.
     * @property {module:model/AwardReduced}
     */
    AwardReduced,

    /**
     * The AwardReducedAllOf model constructor.
     * @property {module:model/AwardReducedAllOf}
     */
    AwardReducedAllOf,
    ...
    /**
     * The AwardStateActions model constructor.
     * @property {module:model/AwardStateActions}
     */
    AwardStateActions,
    ...
    /**
     * The DeclineAwardRequest model constructor.
     * @property {module:model/DeclineAwardRequest}
     */
    DeclineAwardRequest,
    ...
    /**
     * The InstantWinAvailablePlaysRequest model constructor.
     * @property {module:model/InstantWinAvailablePlaysRequest}
     */
    InstantWinAvailablePlaysRequest,

    /**
     * The InstantWinDonateRequest model constructor.
     * @property {module:model/InstantWinDonateRequest}
     */
    ...
    /**
     * The InstantWinPlayResults model constructor.
     * @property {module:model/InstantWinPlayResults}
     */
    ...
    /**
     * The InstantWinsAvailablePlayResponse model constructor.
     * @property {module:model/InstantWinsAvailablePlayResponse}
     */
    InstantWinsAvailablePlayResponse,

    /**
     * The InstantWinsAvailablePlayResults model constructor.
     * @property {module:model/InstantWinsAvailablePlayResults}
     */
    ...
    /**
     * The MemberTokenInfo model constructor.
     * @property {module:model/MemberTokenInfo}
     */
    MemberTokenInfo,
    ...
    /**
     * The MemberTokenResponse model constructor.
     * @property {module:model/MemberTokenResponse}
     */
    MemberTokenResponse,
    ...
    /**
     * The UpdateMessageStateRequest model constructor.
     * @property {module:model/UpdateMessageStateRequest}
     */
    UpdateMessageStateRequest,

    /**
     * The UpdateMessageStateRequestAllOf model constructor.
     * @property {module:model/UpdateMessageStateRequestAllOf}
     */
