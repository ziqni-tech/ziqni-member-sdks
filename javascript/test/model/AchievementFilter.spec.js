...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.AchievementFilter();
  });
  ...
  describe('AchievementFilter', function() {
    it('should create an instance of AchievementFilter', function() {
      ...
      //var instance = new ZiqniMemberApi.AchievementFilter();
      //expect(instance).to.be.a(ZiqniMemberApi.AchievementFilter);
    });
    ...
    it('should have the property scheduleTypes (base name: "scheduleTypes")', function() {
      // uncomment below and update the code to test the property scheduleTypes
      //var instance = new ZiqniMemberApi.AchievementFilter();
      //expect(instance).to.be();
    });

    it('should have the property includeOptInState (base name: "includeOptInState")', function() {
      // uncomment below and update the code to test the property includeOptInState
      //var instance = new ZiqniMemberApi.AchievementFilter();
      //expect(instance).to.be();
    });
