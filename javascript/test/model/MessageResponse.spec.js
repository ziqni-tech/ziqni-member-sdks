...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniTechGamificationApiClient.MessageResponse();
  });
  ...
  describe('MessageResponse', function() {
    it('should create an instance of MessageResponse', function() {
      ...
      //var instance = new ZiqniTechGamificationApiClient.MessageResponse();
      //expect(instance).to.be.a(ZiqniTechGamificationApiClient.MessageResponse);
    });
