...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.InstantWinAllOf();
  });
  ...
  describe('InstantWinAllOf', function() {
    it('should create an instance of InstantWinAllOf', function() {
      // uncomment below and update the code to test InstantWinAllOf
      //var instance = new ZiqniMemberApi.InstantWinAllOf();
      //expect(instance).to.be.a(ZiqniMemberApi.InstantWinAllOf);
    });
