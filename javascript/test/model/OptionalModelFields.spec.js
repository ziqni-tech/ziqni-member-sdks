...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.OptionalModelFields();
  });
  ...
  describe('OptionalModelFields', function() {
    it('should create an instance of OptionalModelFields', function() {
      ...
      //var instance = new ZiqniMemberApi.OptionalModelFields();
      //expect(instance).to.be.a(ZiqniMemberApi.OptionalModelFields);
    });
