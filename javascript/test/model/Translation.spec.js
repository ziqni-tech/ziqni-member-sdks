...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGamificationApiClient.Translation();
  });
  ...
  describe('Translation', function() {
    it('should create an instance of Translation', function() {
      ...
      //var instance = new @ZiqniTechGamificationApiClient.Translation();
      //expect(instance).to.be.a(@ZiqniTechGamificationApiClient.Translation);
    });
