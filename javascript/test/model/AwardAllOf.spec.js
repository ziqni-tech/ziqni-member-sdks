...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.AwardAllOf();
  });
  ...
  describe('AwardAllOf', function() {
    it('should create an instance of AwardAllOf', function() {
      // uncomment below and update the code to test AwardAllOf
      //var instance = new ZiqniMemberApi.AwardAllOf();
      //expect(instance).to.be.a(ZiqniMemberApi.AwardAllOf);
    });
    ...
    it('should have the property activeUntil (base name: "activeUntil")', function() {
      // uncomment below and update the code to test the property activeUntil
      //var instance = new ZiqniMemberApi.AwardAllOf();
      //expect(instance).to.be();
    });
