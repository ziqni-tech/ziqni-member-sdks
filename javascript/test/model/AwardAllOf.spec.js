...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGamificationApiClient.AwardAllOf();
  });
  ...
  describe('AwardAllOf', function() {
    it('should create an instance of AwardAllOf', function() {
      ...
      //var instance = new @ZiqniTechGamificationApiClient.AwardAllOf();
      //expect(instance).to.be.a(@ZiqniTechGamificationApiClient.AwardAllOf);
    });
