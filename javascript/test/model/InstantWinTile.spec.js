...
(function(root, factory) {
  ...
  describe('InstantWinTile', function() {
    ...
    it('should have the property horizontalPosition (base name: "horizontalPosition")', function() {
      // uncomment below and update the code to test the property horizontalPosition
      //var instance = new ZiqniMemberApi.InstantWinTile();
      //expect(instance).to.be();
    });

    it('should have the property verticalPosition (base name: "verticalPosition")', function() {
      // uncomment below and update the code to test the property verticalPosition
      //var instance = new ZiqniMemberApi.InstantWinTile();
      //expect(instance).to.be();
    });
