...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.DeclineAwardRequest();
  });
  ...
  describe('DeclineAwardRequest', function() {
    it('should create an instance of DeclineAwardRequest', function() {
      // uncomment below and update the code to test DeclineAwardRequest
      //var instance = new ZiqniMemberApi.DeclineAwardRequest();
      //expect(instance).to.be.a(ZiqniMemberApi.DeclineAwardRequest);
    });
