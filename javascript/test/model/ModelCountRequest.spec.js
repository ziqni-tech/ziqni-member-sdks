...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.ModelCountRequest();
  });
  ...
  describe('ModelCountRequest', function() {
    it('should create an instance of ModelCountRequest', function() {
      // uncomment below and update the code to test ModelCountRequest
      //var instance = new ZiqniMemberApi.ModelCountRequest();
      //expect(instance).to.be.a(ZiqniMemberApi.ModelCountRequest);
    });
