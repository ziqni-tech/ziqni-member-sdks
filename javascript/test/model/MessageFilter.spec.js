...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.MessageFilter();
  });
  ...
  describe('MessageFilter', function() {
    it('should create an instance of MessageFilter', function() {
      // uncomment below and update the code to test MessageFilter
      //var instance = new ZiqniMemberApi.MessageFilter();
      //expect(instance).to.be.a(ZiqniMemberApi.MessageFilter);
    });
    ...
    it('should have the property expiryDateRange (base name: "expiryDateRange")', function() {
      // uncomment below and update the code to test the property expiryDateRange
      //var instance = new ZiqniMemberApi.MessageFilter();
      //expect(instance).to.be();
    });

    it('should have the property createdDateRange (base name: "createdDateRange")', function() {
      // uncomment below and update the code to test the property createdDateRange
      //var instance = new ZiqniMemberApi.MessageFilter();
      //expect(instance).to.be();
    });
