...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGamificationApiClient.AchievementResponse();
  });
  ...
  describe('AchievementResponse', function() {
    it('should create an instance of AchievementResponse', function() {
      ...
      //var instance = new @ZiqniTechGamificationApiClient.AchievementResponse();
      //expect(instance).to.be.a(@ZiqniTechGamificationApiClient.AchievementResponse);
    });
