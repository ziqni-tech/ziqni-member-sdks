...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.AchievementResponse();
  });
  ...
  describe('AchievementResponse', function() {
    it('should create an instance of AchievementResponse', function() {
      ...
      //var instance = new ZiqniMemberApi.AchievementResponse();
      //expect(instance).to.be.a(ZiqniMemberApi.AchievementResponse);
    });
