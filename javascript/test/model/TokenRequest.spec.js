...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGamificationApiClient.TokenRequest();
  });
  ...
  describe('TokenRequest', function() {
    it('should create an instance of TokenRequest', function() {
      ...
      //var instance = new @ZiqniTechGamificationApiClient.TokenRequest();
      //expect(instance).to.be.a(@ZiqniTechGamificationApiClient.TokenRequest);
    });
