...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGamificationApiClient.Competition();
  });
  ...
  describe('Competition', function() {
    it('should create an instance of Competition', function() {
      ...
      //var instance = new @ZiqniTechGamificationApiClient.Competition();
      //expect(instance).to.be.a(@ZiqniTechGamificationApiClient.Competition);
    });
