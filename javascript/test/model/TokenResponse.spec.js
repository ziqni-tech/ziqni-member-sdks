...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGamificationApiClient.TokenResponse();
  });
  ...
  describe('TokenResponse', function() {
    it('should create an instance of TokenResponse', function() {
      ...
      //var instance = new @ZiqniTechGamificationApiClient.TokenResponse();
      //expect(instance).to.be.a(@ZiqniTechGamificationApiClient.TokenResponse);
    });
