...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.UnsubscribeRequest();
  });
  ...
  describe('UnsubscribeRequest', function() {
    it('should create an instance of UnsubscribeRequest', function() {
      ...
      //var instance = new ZiqniMemberApi.UnsubscribeRequest();
      //expect(instance).to.be.a(ZiqniMemberApi.UnsubscribeRequest);
    });
