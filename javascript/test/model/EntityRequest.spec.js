...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.EntityRequest();
  });
  ...
  describe('EntityRequest', function() {
    it('should create an instance of EntityRequest', function() {
      // uncomment below and update the code to test EntityRequest
      //var instance = new ZiqniMemberApi.EntityRequest();
      //expect(instance).to.be.a(ZiqniMemberApi.EntityRequest);
    });
