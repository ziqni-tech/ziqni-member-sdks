...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGamificationApiClient.Award();
  });
  ...
  describe('Award', function() {
    it('should create an instance of Award', function() {
      ...
      //var instance = new @ZiqniTechGamificationApiClient.Award();
      //expect(instance).to.be.a(@ZiqniTechGamificationApiClient.Award);
    });
