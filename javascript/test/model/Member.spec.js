...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGamificationApiClient.Member();
  });
  ...
  describe('Member', function() {
    it('should create an instance of Member', function() {
      ...
      //var instance = new @ZiqniTechGamificationApiClient.Member();
      //expect(instance).to.be.a(@ZiqniTechGamificationApiClient.Member);
    });
