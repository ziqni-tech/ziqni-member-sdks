...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZiqniMemberApi.MissionState();
  });
  ...
  describe('MissionState', function() {
    it('should create an instance of MissionState', function() {
      // uncomment below and update the code to test MissionState
      //var instance = new ZiqniMemberApi.MissionState();
      //expect(instance).to.be.a(ZiqniMemberApi.MissionState);
    });
