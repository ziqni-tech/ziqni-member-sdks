...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @ZiqniTechGamificationApiClient.Token();
  });
  ...
  describe('Token', function() {
    it('should create an instance of Token', function() {
      ...
      //var instance = new @ZiqniTechGamificationApiClient.Token();
      //expect(instance).to.be.a(@ZiqniTechGamificationApiClient.Token);
    });
