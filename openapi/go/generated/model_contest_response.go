...
// ContestResponse This is a Contest Response
...
// SetData gets a reference to the given []Contest and assigns it to the Data field.
...
func (o ContestResponse) MarshalJSON() ([]byte, error) {
...
type NullableContestResponse struct {
	value *ContestResponse
	isSet bool
}

func (v NullableContestResponse) Get() *ContestResponse {
	return v.value
}

func (v *NullableContestResponse) Set(val *ContestResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableContestResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableContestResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContestResponse(val *ContestResponse) *NullableContestResponse {
	return &NullableContestResponse{value: val, isSet: true}
}

func (v NullableContestResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContestResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
