...
[**getMissions**](AchievementsApi.md#getMissions) | **POST** /missions | Get achievements by member reference id
[**getMissionsWithHttpInfo**](AchievementsApi.md#getMissionsWithHttpInfo) | **POST** /missions | Get achievements by member reference id
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling AchievementsApi#getMissions");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
