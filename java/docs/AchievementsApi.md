...
[**getAchievementsCount**](AchievementsApi.md#getAchievementsCount) | **POST** /achievements/count | Get achievements count by member reference id
[**getAchievementsCountWithHttpInfo**](AchievementsApi.md#getAchievementsCountWithHttpInfo) | **POST** /achievements/count | Get achievements count by member reference id
...
> CompletableFuture<AchievementCountResponse> getAchievementsCount(modelCountRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<AchievementCountResponse> result = apiInstance.getAchievementsCount(modelCountRequest);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling AchievementsApi#getAchievementsCount");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
CompletableFuture<[**AchievementCountResponse**](AchievementCountResponse.md)>
...
## getAchievementsCountWithHttpInfo

> CompletableFuture<ApiResponse<AchievementCountResponse>> getAchievementsCount getAchievementsCountWithHttpInfo(modelCountRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        ModelCountRequest modelCountRequest = new ModelCountRequest(); // ModelCountRequest | 
        try {
            CompletableFuture<ApiResponse<AchievementCountResponse>> response = apiInstance.getAchievementsCountWithHttpInfo(modelCountRequest);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**AchievementCountResponse**](AchievementCountResponse.md)>>
