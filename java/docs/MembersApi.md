...
| [**getMemberWithHttpInfo**](MembersApi.md#getMemberWithHttpInfo) | **POST** /gc/member-info | Get member information by member reference id |
| [**getMemberOptinInfo**](MembersApi.md#getMemberOptinInfo) | **POST** /gc/member-manage-optin | Get member optin information |
| [**getMemberOptinInfoWithHttpInfo**](MembersApi.md#getMemberOptinInfoWithHttpInfo) | **POST** /gc/member-manage-optin | Get member optin information |
| [**getMemberSession**](MembersApi.md#getMemberSession) | **POST** /gc/member-session | Get member session by member reference id |
| [**getMemberSessionWithHttpInfo**](MembersApi.md#getMemberSessionWithHttpInfo) | **POST** /gc/member-session | Get member session by member reference id |
