...
[**getCompetitionsCountWithHttpInfo**](CompetitionsApi.md#getCompetitionsCountWithHttpInfo) | **POST** /competitions/count | Get competitions by member reference id
...
> CompletableFuture<CompetitionCountResponse> getCompetitionsCount(modelCountRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            CompletableFuture<CompetitionCountResponse> result = apiInstance.getCompetitionsCount(modelCountRequest);
            System.out.println(result.get());
        } catch (ApiException e) {
            System.err.println("Exception when calling CompetitionsApi#getCompetitionsCount");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
CompletableFuture<[**CompetitionCountResponse**](CompetitionCountResponse.md)>
...
## getCompetitionsCountWithHttpInfo

> CompletableFuture<ApiResponse<CompetitionCountResponse>> getCompetitionsCount getCompetitionsCountWithHttpInfo(modelCountRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        ModelCountRequest modelCountRequest = new ModelCountRequest(); // ModelCountRequest | 
        try {
            CompletableFuture<ApiResponse<CompetitionCountResponse>> response = apiInstance.getCompetitionsCountWithHttpInfo(modelCountRequest);
            System.out.println("Status code: " + response.get().getStatusCode());
            System.out.println("Response headers: " + response.get().getHeaders());
            System.out.println("Response body: " + response.get().getData());
        } catch (InterruptedException | ExecutionException e) {
...
CompletableFuture<ApiResponse<[**CompetitionCountResponse**](CompetitionCountResponse.md)>>
