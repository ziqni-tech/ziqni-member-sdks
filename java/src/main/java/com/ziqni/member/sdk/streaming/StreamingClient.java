...
import com.ziqni.member.sdk.streaming.handlers.EventHandler;
...
public class StreamingClient {
    ...
    // Constructor
    public StreamingClient(MemberApiClientConfiguration configuration, String URL, ZiqniSimpleEventBus eventBus) throws Exception {
