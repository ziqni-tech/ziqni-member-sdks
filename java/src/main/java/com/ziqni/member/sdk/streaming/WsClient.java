...
public class WsClient extends WebSocketStompClient{
    ...
    private ZiqniMemberSDKEventBus eventBus;
    ...
    private final MemberApiClientConfiguration configuration;

    public WsClient(final MemberApiClientConfiguration configuration, final String wsUri, final Consumer<Integer> onStateChange, ZiqniMemberSDKEventBus eventBus) throws Exception {
        this(configuration, wsUri, makeAuthHeader(configuration), onStateChange, eventBus);
    }

    protected WsClient(final MemberApiClientConfiguration configuration, final String wsUri, final StompHeaders stompHeaders, final Consumer<Integer> onStateChange, ZiqniMemberSDKEventBus eventBus) {
        super(makeSockJs());
        this.wsUri = wsUri;
    ...
    private static StompHeaders makeAuthHeader(MemberApiClientConfiguration configuration) throws Exception{
        StompHeaders stompHeaders = new StompHeaders();
        updateOauthToken(configuration,stompHeaders);
        return stompHeaders;
    }

    private static void updateOauthToken(MemberApiClientConfiguration configuration, StompHeaders stompHeaders) throws Exception{
