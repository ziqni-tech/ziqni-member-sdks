...
import com.ziqni.member.sdk.model.CompetitionStatus;
import com.ziqni.member.sdk.model.CompetitionType;
import com.ziqni.member.sdk.model.ProductReduced;
...
public class CompetitionAllOf {
  ...
  private List<ProductReduced> products = null;

  public CompetitionAllOf() { 
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of rounds to be played in a competition")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "5", value = "The code of the competition")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "- hasTranslations - hasRewards - isPublic - optinRequiredForEntrants", value = "Additional constraints")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(competitionType, numberOfRounds, numberOfGroupStages, maxNumberOfEntrants, minNumberOfEntrants, name, description, termsAndConditions, entrantMemberType, scheduledStartDate, scheduledEndDate, actualStartDate, actualEndDate, status, statusCode, constraints, products);
  }
