...
public struct FileObject: Codable, Hashable {
    ...
    public init(id: String, spaceName: String? = nil, created: Date? = nil, customFields: [String: AnyCodable]? = nil, tags: [String]? = nil, metadata: [String: String]? = nil, repositoryId: String, name: String, mimeType: String, path: String, parentFolderPath: String, uri: String? = nil, size: Int64? = nil, constraints: [String]? = nil) {
        self.id = id
