...
public struct ContestReduced: Codable, Hashable {
    ...
    public init(competitionId: String? = nil, row: Int? = nil, name: String? = nil, round: Int? = nil, groupStage: Int? = nil, entrantsFromContest: [String]? = nil, status: ContestStatus? = nil, statusCode: Int? = nil, scheduledStartDate: Date? = nil, scheduledEndDate: Date? = nil, actualStartDate: Date? = nil, actualEndDate: Date? = nil, tags: [String]? = nil, rewards: [RewardReduced]? = nil) {
