...
public struct LeaderboardMember: Codable, Hashable {
    ...
    public init(name: String, memberId: String, memberRefId: String, rankChangeFrom: Int? = nil, rankChangeType: Int? = nil, params: [String: Double]? = nil, goalReached: Bool? = nil) {
        self.name = name
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(goalReached, forKey: .goalReached)
    }
}
