...
public struct Reward: Codable, Hashable {
    ...
    public init(entityType: EntityType? = nil, entityId: String? = nil, name: String? = nil, description: String? = nil, rewardRank: String? = nil, rewardValue: Double? = nil, rewardType: RewardTypeReduced? = nil, icon: String? = nil, issueLimit: Int? = nil, delay: Int? = nil, pointInTime: Date? = nil, period: Int? = nil, id: String? = nil, constraints: [String]? = nil) {
