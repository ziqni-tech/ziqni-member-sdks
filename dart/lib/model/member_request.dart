...
class MemberRequest {
  ...
  MemberRequest({
    ...
    this.includeCustomFields = const [],
    this.includeMetaDataFields = const [],
  });
  ...
  List<String> includeMetaDataFields;

  @override
  bool operator ==(Object other) => identical(this, other) || other is MemberRequest &&
    _deepEquality.equals(other.includeFields, includeFields) &&
    _deepEquality.equals(other.includeCustomFields, includeCustomFields) &&
    _deepEquality.equals(other.includeMetaDataFields, includeMetaDataFields);

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (includeFields.hashCode) +
    (includeCustomFields.hashCode) +
    (includeMetaDataFields.hashCode);

  @override
  String toString() => 'MemberRequest[includeFields=$includeFields, includeCustomFields=$includeCustomFields, includeMetaDataFields=$includeMetaDataFields]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'includeFields'] = this.includeFields;
      json[r'includeCustomFields'] = this.includeCustomFields;
      json[r'includeMetaDataFields'] = this.includeMetaDataFields;
    return json;
  }
  ...
  static MemberRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return MemberRequest(
        includeFields: json[r'includeFields'] is Iterable
            ? (json[r'includeFields'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        includeCustomFields: json[r'includeCustomFields'] is Iterable
            ? (json[r'includeCustomFields'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        includeMetaDataFields: json[r'includeMetaDataFields'] is Iterable
            ? (json[r'includeMetaDataFields'] as Iterable).cast<String>().toList(growable: false)
            : const [],
      );
    }
    return null;
